...
import jz.cbq.holder.ViewHolder;
        ...
        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            ...
            builder
                    ...
                    .setPositiveButton("确定", (dialog, which) -> {
                        Toast.makeText(MainActivity.this, "您点击了 确定", Toast.LENGTH_SHORT).show();
                        flag.set(true);
                        Toast.makeText(MainActivity.this,"FLAG" + flag.get(),Toast.LENGTH_SHORT).show();
                    })
                    .setNegativeButton("取消", (dialog, which) -> {
                        Toast.makeText(MainActivity.this, "您点击了 取消", Toast.LENGTH_SHORT).show();
                        Toast.makeText(MainActivity.this,"FLAG" + flag.get(),Toast.LENGTH_SHORT).show();
                    })
                    .create().show();
            return flag.get();
